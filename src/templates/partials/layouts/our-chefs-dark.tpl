...
{% macro render() %}
	<div class="inner--ocd">
		...
		<ul class="ocd__chefs-list">
			<li class="ocd__chef">
				<img class="ocd__chef-picture" src="./src/img/cd1.png" alt=""/>
			...
			<li class="ocd__chef">
				<img class="ocd__chef-picture" src="./src/img/cd2.png" alt=""/>
			...
			<li class="ocd__chef">
				<img class="ocd__chef-picture" src="./src/img/cd3.png" alt=""/>
