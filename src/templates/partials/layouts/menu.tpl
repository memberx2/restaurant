...
<div class="inner--menu">
	...
	<div class="lists-container">
		<ul class="menu__list--left">
			<li class="menu__item">
				<img class="menu__image" src="./src/img/1.png" alt=""/>
			...
			<li class="menu__item">
				<img class="menu__image" src="./src/img/2.png" alt=""/>
				<div class="menu__item--text-container">
		...
		<ul class="menu__list--right">
			<li class="menu__item">
				<img class="menu__image" src="./src/img/3.png" alt=""/>
				<div class="menu__item--text-container">
			...
			<li class="menu__item">
				<img class="menu__image" src="./src/img/4.png" alt=""/>
				<div class="menu__item--text-container">
